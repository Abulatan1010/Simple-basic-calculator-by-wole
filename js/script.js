...
var saved = localStorage.getItem("showme", woledis.value);
if (saved) {
  woledis.value = saved;
}
// It will allow the entered data stay on the websites when reload
...
// i used the value parameter to replace the name append name in the html buttons append()
function append(value) {
  woledis.value += value;

  //  save added data into localStorage
   localStorage.setItem("showme", woledis.value);
}
...
function deletedisplay() {
  ...
  // reduce entered data in the localStorage
  localStorage.setItem("showme", woledis.value);
}

// This function here will clear the input in the text at once
function cleardisplay() {
  // clear entered data in the localStorage
  woledis.value = "";
  localStorage.removeItem("showme", woledis.value);
}
...
function calculate() {
  try {
    if (woledis.value.trim() === "") return;
    woledis.value = eval(woledis.value);
    // saved calculated data in the localStorage
    localStorage.setItem("showme", woledis.value);
  } catch {
...
document.addEventListener("keydown", function (e) {
  ...
  // saved entered data after key press
  localStorage.setItem("showme", woledis);
});
